...
x = cv2.imread('test/2/left0450.jpg')


classes = ['0', '1', '2']
train_generator = datagen_train.flow_from_directory(directory=abs_path, classes=classes, class_mode='categorical', batch_size=32, target_size=(x.shape[0], x.shape[1]))
